...
public class DownloaderTaskFragment extends Fragment {
    ...
    public class DownloaderTask extends AsyncTask<ArrayList<Integer>, Void, String[]> {
        ...
        protected String[] doInBackground(ArrayList<Integer>... arrayLists) {
            Integer[] resourceIDS = arrayLists[0].toArray(new Integer[arrayLists[0].size()]);
    ...
    // This helper method simulates downloading Twitter data from the network
    ...
    // This helper method if necessary, notifies the user that the tweet downloads are
    ...
    private void notify(final boolean success) {
        ...
        final Intent restartMainActivityIntent = new Intent(
                mContext,
                MainActivity.class
        );
                ...
                new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        ...
                        if(getResultCode() != MainActivity.IS_ALIVE) {
                            ...
                            // reflect whether the download completed successfully
    ...
    // This helper method saves the tweets to a file
