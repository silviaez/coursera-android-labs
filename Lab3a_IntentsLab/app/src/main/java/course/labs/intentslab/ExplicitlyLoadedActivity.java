...
public class ExplicitlyLoadedActivity extends Activity {
	...
	private void enterClicked() {
		...
		String inputFieldValue = mEditText.getText().toString();

		// Create a new intent and save the input from the EditText field as an extra
		Intent textInputIntent = new Intent();
        //Intent textInputIntent = new Intent(ExplicitlyLoadedActivity.this, ActivityLoaderActivity.class);
        textInputIntent.putExtra("inputValue", inputFieldValue);
		
		// Set Activity's result with result code RESULT_OK
		setResult(RESULT_OK, textInputIntent);
